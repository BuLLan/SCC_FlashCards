		...
		<div class="row">
			<div ng-repeat="box in myboxes" class="loginbox col-lg-3 kachel">
				...
				<div class='row box-config'>
					<div class='col-md-4'>
						<a href="start.html"><icon class='glyphicon glyphicon-user'></icon>
							starten</a>
					</div>
					<div class='col-md-4'>
						<a ng-click="setCurrentBoxID({{box.id}})"><icon
								class='glyphicon glyphicon-user'></icon> bearbeiten</a>
					</div>
					<div class='col-md-4'>
						<a><icon class='glyphicon glyphicon-user'></icon> löschen</a>
					</div>
				</div>
			</div>
		</div>
